...
import { getMoviesByReleaseStatus, formatReleaseDate, getImageFilename, getImagePath } from './despicable-me-data';
...
function Home() {
  ...
  if (isLoading) {
    return (
      <div style={{ textAlign: 'center', padding: '40px 20px' }}>
        <div style={{ fontSize: '24px', marginBottom: '20px', color: '#333' }}>Despicable Me Films</div>
        ...
        <p style={{ marginTop: '20px', opacity: 0.7, color: '#333' }}>Loading Despicable Me movies...</p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div style={{ textAlign: 'center', padding: '40px 20px' }}>
        <h1 style={{ fontSize: '28px', marginBottom: '20px', color: '#333' }}>Error Loading Data</h1>
  ...
  return (
    <div style={{ 
      ...
      <div style={{
        ...
        padding: '60px 20px',
        background: 'linear-gradient(135deg, rgba(51, 51, 51, 0.9), rgba(85, 85, 85, 0.9))',
        position: 'relative',
        ...
        <p style={{ 
          ...
          Explore all {totalMovies} films from the Despicable Me universe featuring Gru and the Minions
        </p>
        ...
        <div style={{ maxWidth: '600px', margin: '40px auto 0' }}>
          <div style={{ position: 'relative' }}>
            ...
            <input
              type="text"
              placeholder="Search for a Despicable Me film..."
              value={searchTerm}
              ...
              onFocus={(e) => e.target.style.backgroundColor = 'rgba(255, 215, 0, 0.3)'}
              onBlur={(e) => e.target.style.backgroundColor = 'rgba(255, 215, 0, 0.2)'}
            />
            <svg 
              style={{
                position: 'absolute',
          ...
          <h2 style={{ 
            ...
            {searchTerm && (
              <button 
                ...
                onMouseOver={(e) => e.target.style.backgroundColor = 'rgba(51,51,51,0.1)'}
          ...
          {upcomingMovies.length > 0 && (
            <div style={{ marginBottom: '50px' }}>
              <h2 style={{ 
                ...
                color: '#333', 
                marginBottom: '20px', 
                borderBottom: '2px solid rgba(51,51,51,0.3)', 
                paddingBottom: '10px',
                display: 'flex',
                alignItems: 'center',
                gap: '10px'
    ...
    >
      <div className="movie-card" style={{
        ...
        <div style={{ padding: '15px', flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
          <h3 style={{ margin: '0 0 8px 0', fontSize: '16px', lineHeight: '1.3', color: '#333' }}>
            {movie.Name}
          </h3>
            ...
            {movie['My Rating'] && movie['My Rating'] !== 'N/A' ? (
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px', gap: '8px' }}>
                {movie['Critic Rating'] && movie['Critic Rating'] !== 'N/A' && (
                  <div className="rating-badge critic" style={{
                ...
                {movie['Audience Rating'] && movie['Audience Rating'] !== 'N/A' && (
                  <div className="rating-badge audience" style={{
