...
import { getMoviesByReleaseStatus, formatReleaseDate, getImageFilename, getImagePath } from '../godzilla-data';
...
function Home() {
  ...
  if (isLoading) {
    return (
      <div style={{ textAlign: 'center', padding: '40px 20px' }}>
        <div style={{ fontSize: '24px', marginBottom: '20px', color: '#ff6500' }}>Godzilla Films</div>
        <div style={{ display: 'inline-block', position: 'relative' }}>
          <div style={{
            width: '50px',
            height: '50px',
            border: '5px solid rgba(255,255,255,0.1)',
            borderTop: '5px solid #ff6500',
            borderRadius: '50%',
            margin: '0 auto',
        ...
        <p style={{ marginTop: '20px', opacity: 0.7, color: 'white' }}>Loading Godzilla movies...</p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div style={{ textAlign: 'center', padding: '40px 20px' }}>
        <h1 style={{ fontSize: '28px', marginBottom: '20px', color: '#ff6500' }}>Error Loading Data</h1>
        <p style={{ marginBottom: '20px', color: '#ff8500' }}>{error}</p>
        <button 
          onClick={() => window.location.reload()}
          className="godzilla-button"
        >
          Try Again
        </button>
      </div>
  ...
  return (
    <div style={{ 
      ...
      <div style={{
        ...
        padding: '60px 20px',
        backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(/godzilla/assets/godzilla-background.jpg)',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        position: 'relative',
        boxShadow: 'inset 0 0 100px rgba(255, 69, 0, 0.3)',
      }}>
        <style>{`
          @keyframes title-glow {
            0%, 100% { text-shadow: 0 0 20px rgba(255, 101, 0, 0.5); }
            50% { text-shadow: 0 0 40px rgba(255, 101, 0, 0.8); }
          }
        `}</style>
        <h1 style={{ 
          fontSize: '48px', 
        ...
        <p style={{ 
          ...
          Explore all {totalMovies} epic films from the MonsterVerse - King of the Monsters
        </p>
          ...
          <div style={{ position: 'relative' }}>
            <style>{`
              @keyframes search-glow {
                0%, 100% { box-shadow: 0 0 10px rgba(255, 101, 0, 0.3); }
                50% { box-shadow: 0 0 20px rgba(255, 101, 0, 0.5); }
              }
              .search-input:focus {
            ...
            <input
              type="text"
              placeholder="Search for a Godzilla film..."
              value={searchTerm}
      ...
      {filteredMovies ? (
        ...
        <div style={{ marginBottom: '50px' }}>
          <h2 style={{ 
            ...
            color: 'white', 
            marginBottom: '20px', 
            borderBottom: '2px solid rgba(255,101,0,0.3)', 
            paddingBottom: '10px',
            display: 'flex',
            alignItems: 'center',
            gap: '10px'
            ...
            {searchTerm && (
              <button 
                ...
                onMouseOver={(e) => e.target.style.backgroundColor = 'rgba(255,101,0,0.2)'}
  ...
  return (
    ...
    >
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = '0 12px 30px rgba(255, 101, 0, 0.4), 0 0 20px rgba(255, 101, 0, 0.2)';
        e.currentTarget.style.backgroundColor = 'rgba(255, 101, 0, 0.05)';
      }}
      onMouseLeave={(e) => {
      ...
      >
        ...
        <div style={{ position: 'relative', paddingTop: '150%', overflow: 'hidden' }}>
          ...
          {new Date(movie.parsedReleaseDate) > new Date() && (
            <div style={{
              ...
              fontSize: '11px',
              fontWeight: 'bold',
              boxShadow: '0 3px 10px rgba(255, 101, 0, 0.4)',
              textTransform: 'uppercase',
              letterSpacing: '0.5px',
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            marginBottom: '12px',
            fontWeight: '500',
            textShadow: '0 0 5px rgba(255, 101, 0, 0.3)'
          }}>
                ...
                {movie['Audience Rating'] && movie['Audience Rating'] !== 'N/A' && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                    <span style={{ 
                      ...
                      fontSize: '11px',
                      border: '1px solid rgba(255, 255, 255, 0.2)',
                      boxShadow: '0 2px 4px rgba(255, 101, 0, 0.3)'
                    }}>
