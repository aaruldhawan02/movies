...
function MoviePage() {
  ...
  if (isLoading) {
    return (
      <div style={{ textAlign: 'center', padding: '40px 20px' }}>
        <div style={{ fontSize: '24px', marginBottom: '20px' }}>Star Wars Movie Details</div>
  ...
  if (error) {
    return (
      <div style={{ textAlign: 'center', padding: '40px 20px' }}>
        <h1 style={{ fontSize: '28px', marginBottom: '20px', color: '#FFE81F' }}>Error Loading Movie</h1>
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        position: 'relative',
        backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.9)), url(/star-wars/assets/sw-pattern-bg.jpg)',
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ 
                ...
                <div style={{
                  ...
                  {/* Status Badge */}
                  <div style={{
                    backgroundColor: isUpcoming ? '#7C3AED' : '#FFE81F',
                    color: isUpcoming ? 'white' : 'black',
                    padding: '8px 15px',
                    borderRadius: '30px',
                    display: 'flex',
                    alignItems: 'center',
                ...
                <div style={{ 
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      fontWeight: 'bold',
                      fontSize: '22px',
                      boxShadow: '0 4px 10px rgba(255, 232, 31, 0.3)'
                    }}>
                      {movie['Critic Rating']}
                    </div>
                  </div>
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      fontWeight: 'bold',
                      fontSize: '22px',
                      boxShadow: '0 4px 10px rgba(75, 180, 230, 0.3)',
                      position: 'relative'
                    }}>
                      {/* Star rating display */}
                      <div style={{ 
                        ...
                        {(() => {
                          ...
                          for (let i = 0; i < fullStars; i++) {
                            stars.push(
                              <svg key={`full-${i}`} style={{ width: '16px', height: '16px', fill: '#FFE81F' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
