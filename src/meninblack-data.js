...
const config = {
  basePath: `${process.env.PUBLIC_URL || ''}/meninblack`, // Base path for the project
  csvFileName: 'meninblack.csv'
};
...
/**
 * Loads and parses the Men in Black movies CSV file
    ...
    const fallbackData = [
      {
        ...
        "parsedReleaseDate": new Date(1997, 6, 2)
      },
      {
        ...
        "Audience Rating": "45%",
        "My Rating": "1/5",
        "Trailer": "https://www.youtube.com/watch?v=DMHlNR6x2Sw",
        "parsedReleaseDate": new Date(2002, 6, 3)
      },
      {
        ...
        "parsedReleaseDate": new Date(2012, 4, 25)
      },
      {
        ...
        "parsedReleaseDate": new Date(2019, 5, 14)
      }
    ];
