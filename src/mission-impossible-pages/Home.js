...
import { getMoviesByReleaseStatus, formatReleaseDate, getImageFilename, getImagePath } from '../mission-impossible-data';
...
function Home() {
  ...
  if (isLoading) {
    return (
      <div style={{ textAlign: 'center', padding: '40px 20px' }}>
        <div style={{ fontSize: '24px', marginBottom: '20px', color: '#c00000' }}>Mission: Impossible Films</div>
        ...
        <p style={{ marginTop: '20px', opacity: 0.7, color: 'white' }}>Loading Mission: Impossible movies...</p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div style={{ textAlign: 'center', padding: '40px 20px' }}>
        <h1 style={{ fontSize: '28px', marginBottom: '20px', color: '#c00000' }}>Error Loading Data</h1>
  ...
  return (
    <div style={{ 
      ...
      <div style={{
        ...
        padding: '60px 20px',
        backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(/mission-impossible/assets/mi-background.jpg)',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        position: 'relative',
        boxShadow: 'inset 0 0 100px rgba(192, 0, 0, 0.3)',
      }}>
        <style>{`
          @keyframes title-glow {
            0%, 100% { text-shadow: 0 0 20px rgba(192, 0, 0, 0.5); }
            50% { text-shadow: 0 0 40px rgba(192, 0, 0, 0.8); }
          }
        `}</style>
        <h1 style={{ 
          fontSize: '48px', 
        ...
        <p style={{ 
          ...
          Explore all {totalMovies} high-octane spy thrillers from the Mission: Impossible franchise
        </p>
          ...
          <div style={{ position: 'relative' }}>
            <style>{`
              @keyframes search-glow {
                0%, 100% { box-shadow: 0 0 10px rgba(192, 0, 0, 0.3); }
            ...
            <input
              type="text"
              placeholder="Search for a Mission: Impossible film..."
              value={searchTerm}
      ...
      {filteredMovies ? (
        ...
        <div style={{ marginBottom: '50px' }}>
          <h2 style={{ 
            ...
            color: 'white', 
            marginBottom: '20px', 
            borderBottom: '2px solid rgba(192,0,0,0.3)', 
            paddingBottom: '10px',
            display: 'flex',
            alignItems: 'center',
            gap: '10px',
            ...
            {searchTerm && (
              <button 
                ...
                onMouseOver={(e) => e.target.style.backgroundColor = 'rgba(192,0,0,0.2)'}
        ...
        // Regular view with released movies section
        <div>
          ...
          <div style={{ marginTop: 'auto' }}>
            {movie['My Rating'] && movie['My Rating'] !== 'N/A' ? (
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                {renderStarRating(movie['My Rating'], movie.Name)}
              </div>
            ) : (
